...
function BarChart03({
  ...
  useEffect(() => {
    ...
    const newChart = new Chart(ctx, {
      type: 'bar',
      data: data || { datasets: [] },  // Provide a default empty data structure
      options: {
        indexAxis: 'y',
        layout: {
          padding: {
        ...
        scales: {
          x: {
            stacked: true,
            display: false,
            max: calculateMax(),  // Use a function to calculate max
          },
          y: {
            stacked: true,
            display: false,
      ...
      plugins: [
        {
          ...
          afterUpdate(c, args, options) {
            ...
            items.forEach((item) => {
              ...
              const valueText = document.createTextNode(`${parseInt((theValue / calculateMax()) * 100)}%`);
